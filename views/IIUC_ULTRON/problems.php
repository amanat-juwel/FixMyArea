            ...
            foreach ($someData as $oneData) { ?>
                ...
                <div class="technology_list">
                    ...
                    <div class="col-md-10 tech_para">
                        <p class="para">Submitted by <strong><?php echo $oneData->author; ?></strong> at
                            <strong><?php echo $oneData->date; ?></strong></p>
                    </div>
                    <div class="col-md-10 tech_para">
                        <p class="para"><?php echo $oneData->description; ?></p>
                    </div>
                    <div class="col-md-2">
                        <span class="bg"><img src="../../resource/images/images/<?php echo $oneData->image_1; ?>"
                                              alt="Image" class="img-rounded" width=150px; height=150px;></span>
                    </div>
                    <div class="clearfix"></div>
                    <div class="read_more">


                        <a href="single_view.php?id=<?php echo $oneData->id ?>" class="fa-btn btn-1 btn-1e">View
                            more</a>
                    </div>
                </div>
