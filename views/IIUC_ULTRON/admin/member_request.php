...
<h2 style="text-align:center">Member requests</h2>
...
<?php 
       ...
       <tr>
		...
		<td><a class="btn btn-success" href="member_accept.php?user_id=<?php echo $oneData->user_id; ?>"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> accept &nbsp</a> 
		<a href="member_delete.php?user_id=<?php echo $oneData->user_id ?>" onclick="return confirm('Are you sure you want to delete this item?');"  class="btn btn-danger" role="button"><span class="glyphicon glyphicon - trash"></span> Reject</a>
        </td> 
